	...
	<div class="wrap">
		...
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="item"><img src="images/7q.jpg" style="width:600px;height:350px;"/> </div>
				<div class="item"><img src="images/8y.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/9w.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/11.png"style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/10q.jpg"style="width:600px;height:350px;"/></div>
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">  &copy; 2021-22 Copyright PVT Ltd.</p>	
			</div>
			<div style="float:right;">
			<p class="text-right text-info">	Project By : Sujith M</p>
			</div>
		</div>
		</footer>	</div>
